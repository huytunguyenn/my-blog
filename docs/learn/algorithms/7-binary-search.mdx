...
## Examples
- [LeetCode 74: Search a 2D Matrix](https://leetcode.com/problems/search-a-2d-matrix): use binary search idea on matrix, [solution](https://github.com/tu-learnspace/algorithms/blob/main/12-Binary-Search/LC-74-Search-a-2D-Matrix.py)
